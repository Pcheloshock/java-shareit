...
class ItemRequestControllerTest {
    ...
    void getUserRequests_ReturnsList() throws Exception {
        List<ItemRequestDto> requests = List.of(
                ItemRequestDto.builder().id(1L).description("Request 1").created(LocalDateTime.now()).build(),
                ItemRequestDto.builder().id(2L).description("Request 2").created(LocalDateTime.now()).build()
        );
